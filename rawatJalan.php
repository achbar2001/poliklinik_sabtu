                ...
                .then(data => {
                    ...
                    if (data != "") {
                        ...
                        data.forEach(function(jadwal) {
                            ...
                            let status = (jadwal.statues != 1) ? '<p class="bg-danger text-white border rounded p-1 mb-0">Tidak Aktif</p>' : '<p class="bg-success text-white border rounded p-1 mb-0">Aktif</p>';
